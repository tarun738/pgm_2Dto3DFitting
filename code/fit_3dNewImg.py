...
#        newsmpl_ids  = smpl_ids[:2]
#        newsmpl_ids += smpl_ids[4:7]
...
#        newweights = np.append(weights[:2],weights[4:7])
...
def main(base_dir,
    ...
    for ind, img_path in enumerate(img_paths):
        ...
        if not exists(out_path):
            ...
            est = np.array([[208.16989231, 551.00971317,   0.95660961],[217.18445921, 440.8237803 ,   0.95034844],[205.7572001, 298.13772893,   0.71672058], [307.52485061, 290.1131922 ,   0.84360039], [330.58974993, 373.4315443,   0.89375627],[300.27535349, 447.33919287,   0.93902057],[120.7404387 , 277.65216494,   0.99124628],[163.6497514, 236.40919742,   0.98042434],[204.0266289 , 157.62143636,   0.9864912 ],[319.61337924, 161.08250737,   0.9421252],[345.69401622, 259.36452574,   0.96232331],[372.93859208, 336.22508955,   0.93514031],[258.30469859, 135.7401123 ,   0.99542588],[256.57129288,  69.74710965,   0.98001844]]);
            joints = est[:, :2]
            conf = est[:, 2]
